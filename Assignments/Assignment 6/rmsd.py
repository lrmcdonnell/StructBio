...
MODEL_DIR = os.path.join(SCRIPT_DIR, "fasta_files", "models")
GDP_REF = os.path.join(SCRIPT_DIR, "fasta_files", "gdp_bound_wt.pdb")
GTP_REF = os.path.join(SCRIPT_DIR, "fasta_files", "gtp_bound_wt.pdb")
...
if not os.path.exists(GDP_REF):
    print(f"❌ Reference file not found: {GDP_REF}")
    exit(1)
if not os.path.exists(GTP_REF):
    print(f"❌ Reference file not found: {GTP_REF}")
    exit(1)
...
plt.savefig("plots_rmsd/rmsd_scatter.png", dpi=300)
print("\nPlot saved as plots_rmsd/rmsd_scatter.png") 